...
// Налаштування Winston для Logstash
const logger = createLogger({
  ...
  transports: [
    new transports.Console(), // Логи виводяться у консоль
    new transports.Http({     // Логи відправляються в Logstash
      host: 'localhost',      // IP Minikube, якщо ви працюєте в Minikube
      port: 5000,             // Порт, на якому працює Logstash
    }),
    new transports.File({ filename: 'logs/app.log' }), // Логи локально у файл
  ],
});
...
app.post('/expenses', (req, res) => {
  ...
  logger.info('New expense created', newExpense); // Логування у Winston
